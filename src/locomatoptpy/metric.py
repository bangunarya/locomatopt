...
def params_matrix(types, B, case):
    ...
    Reference
    ---------
    [1] Hald, Jørgen, and Frank Jensen. Spherical near-field antenna measurements. 
        Vol. 26. Iet, 1988.
...
def maxprod(normA, deg_order):
    ...
    [2] Tight bounds on the mutual coherence of sensing matrices for Wigner D-functions 
        on regular grids
        A Bangun, A Behboodi, R Mathar - 2021 Sampling Theory, Signal Processing, and Data Analysis
