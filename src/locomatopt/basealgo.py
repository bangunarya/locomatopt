...
class BaseAlgo:
    ...
    def __init__(self, params_mat, params_grad):
        ...
        [4] Tight bounds on the mutual coherence of sensing matrices for Wigner D-functions 
            on regular grids
            A Bangun, A Behboodi, R Mathar - 2021 Sampling Theory, Signal Processing, and 
            Data Analysis
    ...
    def lower_bound(self, angles):
        ...
        Returns:
            - coherence bound
                For fixed elevation angle (theta), the lower bound is given in the references 
                [2,3,4]
