...
def coherence_optimization(
    ...
    for idx in range(len(m)):
        ...
        unif_rand = UniformRandom(m = m[idx], polar = 'random') # Wigner polar should random

         
            
        ########################### Gradient ########################
        gradesc = GradDescent(params_mat = params_mat, params_grad = params_grad)
        res_gradesc = gradesc.run_algo(angles=unif_rand.angles,step_size=step_size)
        ...
        res_alm = alm.run_algo(angles = unif_rand.angles, step_size=step_size)
...
if __name__ == '__main__':
    ...
    step_size = None
    total_result = coherence_optimization(m=m,params_mat=params_mat,params_grad=params_grad,step_size=step_size)
